...
// import carrinho from '../../assets/confiralancamentos/shopping-cart.png';
...
//                     <img src={imgconfira} alt="lanche ilustrativo" style={{ width: "480px", height: "490px", marginTop: "80px" }} />
//                 </div>
...
//                 </h1>
//                 <div class="botoes-cardapio">
//                         <button id="butao">Hamburguer</button>
//                         <button id="butao">Hot-Dog</button>
//                         <button id="butao">Pastel</button>
//                         <button id="butao">Porções</button>
//                         <button id="butao">Bebidas</button>
//                 </div>
